...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.fengp.boot";
    private static final String ARTIFACT_ID = "fpbasic";
    private static final String PACKAGE_NAME = "cn.fengp.basic";
    private static final String TITLE = "业务管理系统";
    ...
    public static void main(String[] args) {
        ...
        String groupIdNew = "cn.fengp.boot";//pom中的标识
        String artifactIdNew = "fpbasic";//module前缀
        String packageNameNew = "cn.fengp.basic";//module下级目录名
        String titleNew = "业务管理系统";
//        String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = projectBaseDir.substring(0, projectBaseDir.lastIndexOf("\\") + 1) + "nmt-backend-basic";

package cn.fengp.basic.module.iot.gateway.config;

import cn.fengp.basic.module.iot.core.messagebus.core.IotMessageBus;
import cn.fengp.basic.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import cn.fengp.basic.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import cn.fengp.basic.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import cn.fengp.basic.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import cn.fengp.basic.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import cn.fengp.basic.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import cn.fengp.basic.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import cn.fengp.basic.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import cn.fengp.basic.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import cn.fengp.basic.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import cn.fengp.basic.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import cn.fengp.basic.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import cn.fengp.basic.module.iot.gateway.service.device.IotDeviceService;
import cn.fengp.basic.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "fpbasic.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "fpbasic.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "fpbasic.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "fpbasic.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j

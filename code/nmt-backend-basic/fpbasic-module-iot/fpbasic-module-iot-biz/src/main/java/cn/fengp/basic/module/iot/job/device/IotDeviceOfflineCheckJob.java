package cn.fengp.basic.module.iot.job.device;
...
import cn.fengp.basic.module.iot.framework.iot.config.FpbasicIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private FpbasicIotProperties iotProperties;

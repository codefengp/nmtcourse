package cn.fengp.basic.module.iot.core.messagebus.config;

import cn.fengp.basic.framework.mq.redis.core.RedisMQTemplate;
import cn.fengp.basic.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.fengp.basic.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.fengp.basic.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.fengp.basic.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.fengp.basic.module.iot.core.messagebus.core.IotMessageBus;
import cn.fengp.basic.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.fengp.basic.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.fengp.basic.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import cn.fengp.basic.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "fpbasic.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "fpbasic.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 FpbasicRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.fengp.basic.framework.mq.redis.config.FpbasicRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "fpbasic.iot.message-bus", name = "type", havingValue = "redis")

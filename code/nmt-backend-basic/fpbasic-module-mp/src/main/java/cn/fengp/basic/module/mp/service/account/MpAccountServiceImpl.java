package cn.fengp.basic.module.mp.service.account;
...
import cn.fengp.basic.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.fengp.basic.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.fengp.basic.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.fengp.basic.module.mp.convert.account.MpAccountConvert;
import cn.fengp.basic.module.mp.dal.dataobject.account.MpAccountDO;
import cn.fengp.basic.module.mp.dal.mysql.account.MpAccountMapper;
import cn.fengp.basic.module.mp.enums.ErrorCodeConstants;
...
import static cn.fengp.basic.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 fpbasic-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }

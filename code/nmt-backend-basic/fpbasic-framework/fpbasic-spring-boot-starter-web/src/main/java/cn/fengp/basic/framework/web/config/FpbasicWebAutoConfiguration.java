package cn.fengp.basic.framework.web.config;
...
import cn.fengp.basic.framework.web.core.filter.CacheRequestBodyFilter;
import cn.fengp.basic.framework.web.core.filter.DemoFilter;
import cn.fengp.basic.framework.web.core.handler.GlobalExceptionHandler;
import cn.fengp.basic.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class FpbasicWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "fpbasic.demo", havingValue = "true")

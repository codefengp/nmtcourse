package cn.fengp.basic.framework.jackson.config;

import cn.fengp.basic.framework.common.util.json.JsonUtils;
import cn.fengp.basic.framework.common.util.json.databind.NumberSerializer;
import cn.fengp.basic.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.fengp.basic.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class FpbasicJacksonAutoConfiguration {

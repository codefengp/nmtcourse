package cn.fengp.basic.framework.ratelimiter.config;

import cn.fengp.basic.framework.ratelimiter.core.aop.RateLimiterAspect;
import cn.fengp.basic.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import cn.fengp.basic.framework.ratelimiter.core.keyresolver.impl.*;
import cn.fengp.basic.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class FpbasicRateLimiterConfiguration {

package cn.fengp.basic.framework.excel.core.util;

import cn.idev.excel.FastExcelFactory;
import cn.idev.excel.converters.longconverter.LongStringConverter;
import cn.fengp.basic.framework.common.util.http.HttpUtils;
import cn.fengp.basic.framework.excel.core.handler.ColumnWidthMatchStyleStrategy;
...
public class ExcelUtils {
     ...
     * @throws IOException 写入失败的情况
     */
    public static <T> void write(HttpServletResponse response, String filename) throws IOException {
        // 输出 Excel

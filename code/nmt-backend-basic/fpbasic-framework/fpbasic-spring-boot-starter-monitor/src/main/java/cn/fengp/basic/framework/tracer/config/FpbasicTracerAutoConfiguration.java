...
import cn.fengp.basic.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "fpbasic.tracer", value = "enable", matchIfMissing = true)
public class FpbasicTracerAutoConfiguration {

 ...
 *      1）Spring Async：
 *          {@link cn.fengp.basic.framework.quartz.config.FpbasicAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 FpbasicSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.fengp.basic.framework.tenant;

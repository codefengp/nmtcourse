package cn.fengp.basic.module.ai.service.chat;
...
import cn.fengp.basic.framework.tenant.core.util.TenantUtils;
import cn.fengp.basic.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.fengp.basic.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.fengp.basic.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.fengp.basic.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.fengp.basic.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.fengp.basic.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.fengp.basic.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.fengp.basic.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.fengp.basic.module.ai.dal.dataobject.model.AiModelDO;
import cn.fengp.basic.module.ai.dal.dataobject.model.AiToolDO;
import cn.fengp.basic.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.fengp.basic.module.ai.enums.ErrorCodeConstants;
import cn.fengp.basic.module.ai.enums.model.AiPlatformEnum;
...
import cn.fengp.basic.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.fengp.basic.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.fengp.basic.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.fengp.basic.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.fengp.basic.module.ai.service.model.AiChatRoleService;
import cn.fengp.basic.module.ai.service.model.AiModelService;
import cn.fengp.basic.module.ai.service.model.AiToolService;
import cn.fengp.basic.module.ai.util.AiUtils;
import cn.fengp.basic.module.ai.util.FileTypeUtils;
...
import static cn.fengp.basic.framework.common.pojo.CommonResult.error;
...
import static cn.fengp.basic.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.fengp.basic.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.fengp.basic.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 fpbasic.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 fpbasic.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入

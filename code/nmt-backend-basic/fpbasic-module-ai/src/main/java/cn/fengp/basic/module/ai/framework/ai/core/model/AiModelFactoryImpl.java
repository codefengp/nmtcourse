package cn.fengp.basic.module.ai.framework.ai.core.model;
...
import cn.fengp.basic.framework.common.util.spring.SpringUtils;
import cn.fengp.basic.module.ai.enums.model.AiPlatformEnum;
import cn.fengp.basic.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.fengp.basic.module.ai.framework.ai.config.FpbasicAiProperties;
...
import cn.fengp.basic.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.fengp.basic.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            FpbasicAiProperties.Midjourney properties = SpringUtil.getBean(FpbasicAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(FpbasicAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        FpbasicAiProperties.DouBao properties = new FpbasicAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(FpbasicAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        FpbasicAiProperties.HunYuan properties = new FpbasicAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(FpbasicAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        FpbasicAiProperties.SiliconFlow properties = new FpbasicAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(FpbasicAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        FpbasicAiProperties.XingHuo properties = new FpbasicAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(FpbasicAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        FpbasicAiProperties.BaiChuan properties = new FpbasicAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(FpbasicAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        FpbasicAiProperties.Gemini properties = SpringUtil.getBean(FpbasicAiProperties.class)

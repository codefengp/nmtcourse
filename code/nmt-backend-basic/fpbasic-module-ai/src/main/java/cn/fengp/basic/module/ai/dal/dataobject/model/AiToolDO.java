...
import cn.fengp.basic.module.ai.tool.function.DirectoryListToolFunction;
import cn.fengp.basic.module.ai.tool.function.WeatherQueryToolFunction;
...
public class AiToolDO extends BaseDO {
     ...
     * 状态
     *
     * 枚举 {@link cn.fengp.basic.framework.common.enums.CommonStatusEnum}
     */

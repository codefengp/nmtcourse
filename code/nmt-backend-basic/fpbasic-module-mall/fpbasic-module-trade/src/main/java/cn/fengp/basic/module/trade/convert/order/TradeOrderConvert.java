package cn.fengp.basic.module.trade.convert.order;
...
import cn.fengp.basic.module.member.api.user.dto.MemberUserRespDTO;
import cn.fengp.basic.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.fengp.basic.module.pay.enums.DictTypeConstants;
import cn.fengp.basic.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.fengp.basic.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.fengp.basic.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.fengp.basic.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.fengp.basic.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.fengp.basic.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.fengp.basic.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.fengp.basic.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.fengp.basic.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.fengp.basic.module.trade.controller.admin.order.vo.*;
import cn.fengp.basic.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.fengp.basic.module.trade.controller.app.order.vo.*;
import cn.fengp.basic.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.fengp.basic.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.fengp.basic.module.trade.dal.dataobject.order.TradeOrderLogDO;
import cn.fengp.basic.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.fengp.basic.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.fengp.basic.module.trade.framework.order.config.TradeOrderProperties;
import cn.fengp.basic.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.fengp.basic.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.fengp.basic.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.fengp.basic.framework.common.util.date.LocalDateTimeUtils.addTime;

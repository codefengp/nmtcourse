package cn.fengp.basic.module.system.service.social;
...
import cn.fengp.basic.framework.common.util.cache.CacheUtils;
import cn.fengp.basic.framework.common.util.http.HttpUtils;
import cn.fengp.basic.framework.common.util.object.BeanUtils;
import cn.fengp.basic.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.fengp.basic.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.fengp.basic.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.fengp.basic.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.fengp.basic.module.system.dal.dataobject.social.SocialClientDO;
import cn.fengp.basic.module.system.dal.mysql.social.SocialClientMapper;
import cn.fengp.basic.module.system.dal.redis.RedisKeyConstants;
import cn.fengp.basic.module.system.enums.social.SocialTypeEnum;
import cn.fengp.basic.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.fengp.basic.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.fengp.basic.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${fpbasic.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${fpbasic.wxa-subscribe-message.miniprogram-state:formal}")

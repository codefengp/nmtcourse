package cn.fengp.basic.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.fengp.basic.framework.common.enums.CommonStatusEnum;
import cn.fengp.basic.framework.common.exception.ServiceException;
import cn.fengp.basic.framework.common.pojo.PageResult;
import cn.fengp.basic.framework.common.util.collection.ArrayUtils;
import cn.fengp.basic.framework.common.util.collection.CollectionUtils;
import cn.fengp.basic.framework.test.core.ut.BaseDbUnitTest;
import cn.fengp.basic.module.infra.api.config.ConfigApi;
import cn.fengp.basic.module.infra.api.file.FileApi;
import cn.fengp.basic.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.fengp.basic.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.fengp.basic.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.fengp.basic.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.fengp.basic.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.fengp.basic.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.fengp.basic.module.system.dal.dataobject.dept.DeptDO;
import cn.fengp.basic.module.system.dal.dataobject.dept.PostDO;
import cn.fengp.basic.module.system.dal.dataobject.dept.UserPostDO;
import cn.fengp.basic.module.system.dal.dataobject.tenant.TenantDO;
import cn.fengp.basic.module.system.dal.dataobject.user.AdminUserDO;
import cn.fengp.basic.module.system.dal.mysql.dept.UserPostMapper;
import cn.fengp.basic.module.system.dal.mysql.user.AdminUserMapper;
import cn.fengp.basic.module.system.enums.common.SexEnum;
import cn.fengp.basic.module.system.service.dept.DeptService;
import cn.fengp.basic.module.system.service.dept.PostService;
import cn.fengp.basic.module.system.service.permission.PermissionService;
import cn.fengp.basic.module.system.service.tenant.TenantService;
...
import static cn.fengp.basic.framework.common.util.collection.SetUtils.asSet;
import static cn.fengp.basic.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.fengp.basic.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.fengp.basic.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.fengp.basic.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.fengp.basic.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.fengp.basic.framework.test.core.util.RandomUtils.*;
import static cn.fengp.basic.module.system.enums.ErrorCodeConstants.*;
import static cn.fengp.basic.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("fpbasicyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("fpbasicyuanma");
        ...
        assertEquals("fpbasicyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("fpbasicyuanma"))).thenReturn("java");

package cn.fengp.basic.module.bpm.service.task;
...
import cn.fengp.basic.framework.common.util.object.ObjectUtils;
import cn.fengp.basic.framework.common.util.object.PageUtils;
import cn.fengp.basic.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.fengp.basic.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.fengp.basic.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.fengp.basic.module.bpm.controller.admin.task.vo.instance.*;
import cn.fengp.basic.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.fengp.basic.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.fengp.basic.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.fengp.basic.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.fengp.basic.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.fengp.basic.module.bpm.enums.ErrorCodeConstants;
import cn.fengp.basic.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.fengp.basic.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.fengp.basic.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.fengp.basic.module.bpm.enums.task.BpmReasonEnum;
import cn.fengp.basic.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.fengp.basic.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.fengp.basic.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.fengp.basic.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.fengp.basic.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.fengp.basic.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.fengp.basic.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.fengp.basic.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.fengp.basic.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.fengp.basic.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.fengp.basic.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.fengp.basic.module.bpm.service.message.BpmMessageService;
import cn.fengp.basic.module.system.api.dept.DeptApi;
import cn.fengp.basic.module.system.api.dept.dto.DeptRespDTO;
import cn.fengp.basic.module.system.api.user.AdminUserApi;
import cn.fengp.basic.module.system.api.user.dto.AdminUserRespDTO;
...
import static cn.fengp.basic.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.fengp.basic.module.bpm.enums.ErrorCodeConstants.*;
import static cn.fengp.basic.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.fengp.basic.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_NEED_SIMULATE_PREFIX;
import static cn.fengp.basic.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;

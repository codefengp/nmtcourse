package cn.fengp.basic.module.member.controller.admin.config;

import cn.fengp.basic.framework.common.pojo.CommonResult;
import cn.fengp.basic.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.fengp.basic.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.fengp.basic.module.member.convert.config.MemberConfigConvert;
import cn.fengp.basic.module.member.dal.dataobject.config.MemberConfigDO;
import cn.fengp.basic.module.member.service.config.MemberConfigService;

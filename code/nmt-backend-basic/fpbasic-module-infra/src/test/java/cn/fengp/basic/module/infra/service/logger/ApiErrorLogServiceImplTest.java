package cn.fengp.basic.module.infra.service.logger;
...
import cn.fengp.basic.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.fengp.basic.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.fengp.basic.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.fengp.basic.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.fengp.basic.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.fengp.basic.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("fpbasic-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("fpbasic-test");

package cn.fengp.basic.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.fengp.basic.module.infra.enums.DictTypeConstants.OPERATE_TYPE)

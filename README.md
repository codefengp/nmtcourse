...
- 每门课程有若干课程目标（CO1、CO2、CO3…）
- 每个 CO 有三种考核方式：平时、实验、期末
- 每种考核方式有满分
- 学生在每个 CO 的每种考核方式有实际得分
...
![image-20260202152613866](README.assets/image-20260202152613866.png)
...
✅ 注意：这里每个考核方式得分都严格 ≤ 该考核方式满分，不会出现超分。
...
![image-20260202152717374](README.assets/image-20260202152717374.png)
